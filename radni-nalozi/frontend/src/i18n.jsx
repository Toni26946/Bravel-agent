...
const HR = {
  ...
  'prikapcanje.opis': 'Dnevnik prikapčanja i otkapčanja priključnih vozila (evidencija/dokaz).',
...
const EN = {
  ...
  'prikapcanje.opis': 'Log of trailer coupling and uncoupling (record/proof).',
