...
const HR = {
  ...
  // tabovi / uloge
  'tab.prijave': 'Prijave', 'tab.nalozi': 'Nalozi', 'tab.sifrarnik': 'Povijest vozila',
  'tab.izbornik': 'Tekući radovi', 'tab.vozilaURadu': 'Vozila u radu', 'tab.izasli': 'Izašli',
  'tab.nezaduzena': 'Nezadužena', 'tab.parkiranje': 'Parkiranje', 'tab.vozila': 'Vozila',
  'vozila.opis': 'Matični popis svih vozila. Status postavljaš ručno i on je mjerodavan.',
  'vozila.pretraga': 'Traži po GB-u, registraciji ili tipu…',
  'vozila.sve': 'Sve', 'vozila.sviStatusi': 'Svi statusi', 'vozila.vozila': 'vozila', 'vozila.nema': 'Nema vozila za ovaj filtar.',
  'vozila.mobilisis': 'Mobilisis', 'vozila.rucno': 'ručno',
  'vozila.vratiMobilisis': 'Vrati na Mobilisis', 'vozila.vratiMobilisisOpis': 'Poništi ručni status i preuzmi status iz Mobilisisa',
  'sv.aktivno': 'Aktivno', 'sv.u_radionici': 'U radionici', 'sv.pokvareno': 'Pokvareno', 'sv.prodano': 'Prodano', 'sv.nezaduzeno': 'Nezaduženo', 'sv.spremno': 'Spremno',
  'tab.spremne': 'Spremne', 'tab.prikapcanje': 'Prikapčanje', 'tab.zaduzenja': 'Zaduženje', 'tab.vozaci': 'Vozači',
  'voz.opis': 'Naša evidencija vozača (ime, sektor, telefon). Popis se koristi u obrascu zaduženja.',
  'voz.dodaj': 'Dodaj vozača', 'voz.ime': 'Ime i prezime', 'voz.imePh': 'npr. Ivan Horvat',
  'voz.sektor': 'Sektor', 'voz.telefon': 'Telefon',
  'voz.aktivni': 'Aktivni', 'voz.svi': 'Svi', 'voz.neaktivan': 'neaktivan',
  'voz.trazi': 'Traži po imenu, sektoru ili telefonu…',
  'voz.nema': 'Nema vozača. Dodaj prvog.', 'voz.nemaRezultata': 'Nema rezultata za tu pretragu.',
  'voz.spremi': 'Spremi', 'voz.odustani': 'Odustani', 'voz.uredi': 'Uredi',
  'voz.deaktiviraj': 'Deaktiviraj (izašao)', 'voz.aktiviraj': 'Vrati u aktivne', 'voz.obrisi': 'Obriši',
  'voz.trebaIme': 'Upiši ime vozača.', 'voz.potvrdiBrisanje': 'Obrisati vozača {ime}?',
  'zad.opis': 'Primopredajni obrazac — dokumenti i oprema pri zaduženju kamiona i prikolice vozaču.',
  'zad.novo': 'Novo zaduženje', 'zad.naslov': 'Zaduženje',
  'zad.trazi': 'Traži po registraciji ili vozaču…',
  'zad.nema': 'Još nema zaduženja. Kreiraj prvo.',
  'zad.nemaRezultata': 'Nema rezultata za tu pretragu.',
  'zad.datum': 'Datum', 'zad.kamion': 'Kamion', 'zad.prikolica': 'Prikolica',
  'zad.kamionReg': 'Kamion — registracija', 'zad.prikolicaReg': 'Prikolica — registracija', 'zad.regPh': 'npr. ZG 1234-AB',
  'zad.vozac': 'Vozač', 'zad.vozacPh': 'ime i prezime vozača', 'zad.odaberiVozaca': '— odaberi vozača —',
  'zad.noviVozac': 'Drugi vozač (upiši)…', 'zad.izPopisa': 'odaberi iz popisa',
  'zad.faliPolja': 'Obavezna polja: {polja}',
  'zad.preuzeo': 'Preuzeo', 'zad.predao': 'Predao', 'zad.odradio': 'Odradio',
  'zad.status': 'Status', 'zad.uTijeku': 'U tijeku', 'zad.zavrseno': 'Završeno',
  'zad.oprema': 'Oprema / dokument', 'zad.kom': 'Kom', 'zad.napomena': 'Napomena',
  'zad.napomenaKratko': 'Napomena',
  'zad.sviPredani': 'Sve predano (+)', 'zad.ocisti': 'Očisti',
  'zad.predana': 'Predano', 'zad.manjka': 'Nedostaje',
  'zad.predano': 'Predano: {n} / {uk}',
  'zad.spremi': 'Spremi', 'zad.spremljeno': 'Spremljeno ✓', 'zad.zavrsi': 'Završi',
  'zad.vratiTijek': 'Vrati u tijek', 'zad.ispisi': 'Ispiši', 'zad.obrisi': 'Obriši',
  'zad.potvrdiBrisanje': 'Obrisati ovo zaduženje?',
  'zad.greskaUcitavanje': 'Greška pri učitavanju.',
  'prikapcanje.opis': 'Tko vozi koju prikolicu + dnevnik prikapčanja i otkapčanja (evidencija/dokaz).',
  'prikapcanje.trenutno': 'Trenutno — tko vozi koju prikolicu',
  'prikapcanje.nemaTrenutno': 'Nema trenutno prikačenih prikolica u evidenciji.',
  'prikapcanje.dnevnik': 'Dnevnik događaja',
  'prikapcanje.trazi': 'Traži po kamionu, prikolici, registraciji ili vozaču…',
  'prikapcanje.nemaRezultata': 'Nema rezultata za tu pretragu.',
  'prikapcanje.novaPromjena': 'Nova promjena (prikači / otkači)',
  'prikapcanje.odaberiPrikolicu': '— odaberi prikolicu —',
  'prikapcanje.odaberiKamion': '— odaberi kamion —',
  'prikapcanje.trebaPrikolica': 'Odaberi prikolicu.',
  'prikapcanje.trebaKamion': 'Za prikačivanje odaberi kamion (za otkačivanje nije potrebno).',
  'prikapcanje.napomenaUnos': 'Prikači = prikolica ide na odabrani kamion. Otkači = prikolica se skida (postaje slobodna).',
  'prikapcanje.potvrdiZamjenu': 'Kamion {kamion} već vuče prikolicu {stara}. Otkačiti je i prikačiti {nova}?',
  'tab.servisi': 'Servisi',
  'servisi.opis': 'Rok idućeg servisa po kamionu (zadnji servis + 12 mjeseci). Km uvjet uskoro.',
  'servisi.trazi': 'Traži po GB-u, registraciji ili tipu…',
  'servisi.kamiona': 'kamiona', 'servisi.dospjelo': 'Dospjelo', 'servisi.uskoro': 'Uskoro', 'servisi.ok': 'OK', 'servisi.nepoznato': 'Nepoznato',
  'servisi.zadnji': 'Zadnji servis', 'servisi.iduci': 'Idući', 'servisi.prag': 'Prag', 'servisi.mj': 'mj',
  'servisi.proslo': 'prošlo', 'servisi.jos': 'još', 'servisi.dana': 'dana', 'servisi.obavljen': 'Servis obavljen',
  'servisi.km': 'Km', 'servisi.prekoraceno': 'prekoračeno',
  'spremne.opis': 'Spremne (popravljene) šlepe i gdje su parkirane — da se zna što imamo.',
  'spremne.zaUpisati': 'Za upisati', 'spremne.zaUpisatiOpis': 'Ove šlepe su gotove na nalogu, a nije upisano jesu li spremne i gdje su parkirane. Upiši da se ne zaborave.',
  'spremne.spremne': 'Spremne šlepe', 'spremne.nema': 'Trenutno nema spremnih šlepa.',
  'spremne.spremnoBtn': 'Spremna', 'spremne.uzeta': 'Uzeta', 'spremne.od': 'od',
  'spremne.gdjeParkirana': 'Gdje je parkirana?', 'spremne.lokPlaceholder': 'Npr. Parking Sesvete, Radiona…',
  'spremne.lokObavezna': 'Odaberi parking.',
  'spremne.parkinzi': 'Parkinzi', 'spremne.nemaParkinga': 'Još nema parkinga — dodaj barem jedan.',
  'spremne.noviParking': 'Naziv parkinga', 'spremne.dodajParking': 'Dodaj',
  'spremne.odaberiParking': '— odaberi parking —', 'spremne.trebaParking': 'Voditelj prvo mora dodati parking (⬆ Parkinzi).',
  'spremne.uzetaNaslov': 'Tko je uzeo šlepu? (nije obavezno)', 'spremne.kamionGb': 'Garažni broj kamiona (opc.)', 'spremne.vozacOpc': 'Vozač (opc.)',
  'spremne.evidencija': 'Evidencija prikapčanja', 'spremne.nemaEvidencije': 'Nema zapisa.',
  'spremne.prikaceno': 'Prikačeno', 'spremne.otkaceno': 'Otkačeno', 'spremne.ispisi': 'Ispiši',
  'spremne.kada': 'Kada', 'spremne.dogadaj': 'Događaj', 'spremne.prikolica': 'Prikolica', 'spremne.kamion': 'Kamion',
  'spremne.vozac': 'Vozač', 'spremne.lokacijaKol': 'Lokacija',
  'spremne.kamioni': 'Gotovi kamioni', 'spremne.nemaKamiona': 'Trenutno nema gotovih kamiona u radioni.',
  'spremne.kamioniOpis': 'Kamioni stoje ovdje dok ne napuste krug radione (~{km} km). Nestaju čim odu (po GPS-u).',
  'spremne.nemaGps': 'nema GPS-a', 'spremne.prikaziNaKarti': 'Prikaži na karti (Google Maps)', 'spremne.karta': 'karta',
  'kat.kamion': 'Kamioni', 'kat.prikolica': 'Prikolice', 'kat.kombi': 'Kombiji', 'kat.auto': 'Auti', 'kat.ostalo': 'Ostalo',
  'izasli.opis': 'Kamioni koji su napustili radionu, a nalog je još u radu.',
  'nezaduzena.opis': 'Vozila kojima je ručno postavljen status „Nezaduženo" u matičnom popisu vozila.',
  'nezaduzena.nema': 'Nema nezaduženih šlepa.', 'nezaduzena.slobodnih': 'slobodnih šlepa',
  'nezaduzena.nijeURadionici': 'nije u radionici', 'nezaduzena.nedostupno': 'Flota OS trenutno nedostupan — pokušaj kasnije.',
  'parking.ispisi': 'Ispiši evidenciju', 'parking.zaRijesiti': 'Za riješiti', 'parking.nemaZa': 'Nema šlepa koje čekaju lokaciju.',
  'parking.evidencija': 'Evidencija', 'parking.poslano': 'Poslano', 'parking.otvoreno': 'Otvoreno', 'parking.rijeseno': 'Riješeno',
  'parking.gdjeParkirano': 'Gdje je šlepa parkirana?', 'parking.phLok': 'npr. iza hale, red B', 'parking.spremiLok': 'Spremi lokaciju',
  'parking.upisiLok': 'Upišite lokaciju.', 'parking.lokacija': 'Lokacija', 'parking.ispisNaslov': 'Evidencija parkiranja šlepa',
  'izasli.nema': 'Trenutno nema vozila izvan radione s otvorenim nalogom.',
  'izasli.zavrsi': 'Završi nalog',
  'nadzor.izbornik': 'Tekući radovi', 'nadzor.tekuci': 'Tekući radovi', 'nadzor.zavrsi': 'Završi', 'nadzor.odjavi': 'Odjavi', 'nadzor.uTijeku': 'u tijeku', 'nadzor.vozilaURadu': 'Vozila u radu',
  'nadzor.nemaTekucih': 'Trenutno nema aktivnih mjerača.', 'nadzor.nemaAktivnih': 'Nema aktivnih naloga.',
  'nadzor.slobodni': 'Slobodni radnici', 'nadzor.sviZauzeti': 'Svi radnici su prijavljeni.',
  'common.zatvori': 'Zatvori', 'nav.izbornik': 'Izbornik',
  'radnik.dodaj': 'Dodaj radnika', 'radnik.imePlaceholder': 'Ime i prezime radnika',
  'radnik.pocLozinka': 'Početna lozinka (radnik je poslije mijenja)', 'radnik.spremiDodaj': 'Dodaj',
  'radnik.imeObavezno': 'Upiši ime radnika.', 'radnik.vecPostoji': 'Radnik s tim imenom već postoji.',
  'radnik.dodan': 'Radnik dodan', 'radnik.korisnicko': 'korisničko ime', 'radnik.lozinka': 'lozinka',
  'radnik.josJedan': 'Dodaj još jednog',
  'ods.dostupan': 'Dostupan', 'ods.godisnji': 'Godišnji', 'ods.bolovanje': 'Bolovanje', 'ods.od': 'Od', 'ods.do': 'Do',
  ...
  'nalog.ispisi': 'Ispiši nalog', 'nalog.povijestVozila': 'Povijest vozila',
  'nalog.uredi': 'Uredi', 'nalog.naslovPh': 'Naslov naloga', 'nalog.opisPh': 'Opis / napomena',
  ...
  'profil.testPush': '📨 Pošalji testnu obavijest', 'profil.testPoslano': 'Testna obavijest poslana — provjeri uređaj. 📲',
  'profil.pushServer': 'Push još nije uključen na serveru (nedostaju VAPID ključevi).',
  'profil.pushNepodrzano': 'Ovaj preglednik/uređaj ne podržava push obavijesti.',
  'profil.pushGreska': 'Greška pri uključivanju obavijesti — pokušaj ponovno.',
  ...
  'noviNalog.gbNema': 'Kamion s tim GB ne postoji. Dodaj ga u Povijesti vozila.', 'noviNalog.promijeni': 'Promijeni',
  ...
  'steta.uredi': 'Uredi', 'steta.urediNaslov': 'Uredi štetu', 'steta.spremiIzmjene': 'Spremi izmjene',
  'steta.dodajStavku': '+ dodaj stavku', 'steta.nazivStavke': 'Stavka', 'steta.cijenaStavke': 'Cijena (€)',
  'steta.postaviUkupno': '= zbroj stavki',
  // šifrarnik
  'sif.title': 'Povijest vozila', 'sif.korisnici': 'Radnici', 'sif.vozila': 'Vozila', 'sif.dijelovi': 'Dijelovi',
  ...
  'sif.noviKorisnik': 'Dodaj radnika', 'sif.ime': 'Ime i prezime', 'sif.korime': 'Korisničko ime',
  'sif.korimeHint': 'Automatski iz imena — možeš promijeniti. Zadana lozinka radnik123 (radnik je poslije mijenja).',
  'sif.stoJe': 'Što je?',
  'sif.autoHint': 'Korisničko ime i lozinka se dodjeljuju automatski — dobiješ ih nakon spremanja.',
  'sif.predaj': 'Proslijedi ove podatke radniku; lozinku poslije mijenja sam.',
  'vrsta.serviser': 'Serviser (prijavljuje se na naloge)', 'vrsta.neprijavljuje': 'Ne prijavljuje se (npr. skladištar)',
  'vrsta.poslovodja': 'Poslovođa', 'vrsta.voditelj': 'Voditelj', 'vrsta.vozac': 'Vozač',
  ...
  'sif.vrsta': 'Vrsta', 'sif.serviser': 'Serviser (prijavljuje se)', 'sif.nePrijavljuje': 'Ne prijavljuje se (npr. skladištar)',
  'sif.postaviNePrijavljuje': 'Postavi: ne prijavljuje se', 'sif.postaviServiser': 'Postavi: serviser',
...
const EN = {
  ...
  'tab.prijave': 'Reports', 'tab.nalozi': 'Orders', 'tab.sifrarnik': 'Vehicle history',
  'tab.izbornik': 'Main menu', 'tab.vozilaURadu': 'Trucks', 'tab.izasli': 'Left shop',
  'tab.nezaduzena': 'Unassigned', 'tab.parkiranje': 'Parking', 'tab.vozila': 'Vehicles',
  'vozila.opis': 'Master list of all vehicles. You set the status manually and it is authoritative.',
  'vozila.pretraga': 'Search by yard no., plate or type…',
  'vozila.sve': 'All', 'vozila.sviStatusi': 'All statuses', 'vozila.vozila': 'vehicles', 'vozila.nema': 'No vehicles for this filter.',
  'vozila.mobilisis': 'Mobilisis', 'vozila.rucno': 'manual',
  'vozila.vratiMobilisis': 'Reset to Mobilisis', 'vozila.vratiMobilisisOpis': 'Clear manual status and take the status from Mobilisis',
  'sv.aktivno': 'Active', 'sv.u_radionici': 'In shop', 'sv.pokvareno': 'Broken', 'sv.prodano': 'Sold', 'sv.nezaduzeno': 'Unassigned', 'sv.spremno': 'Ready',
  'tab.spremne': 'Ready', 'tab.prikapcanje': 'Coupling', 'tab.zaduzenja': 'Handover', 'tab.vozaci': 'Drivers',
  'voz.opis': 'Our driver registry (name, sector, phone). Used in the handover form.',
  'voz.dodaj': 'Add driver', 'voz.ime': 'Full name', 'voz.imePh': 'e.g. Ivan Horvat',
  'voz.sektor': 'Sector', 'voz.telefon': 'Phone',
  'voz.aktivni': 'Active', 'voz.svi': 'All', 'voz.neaktivan': 'inactive',
  'voz.trazi': 'Search by name, sector or phone…',
  'voz.nema': 'No drivers. Add the first one.', 'voz.nemaRezultata': 'No results for that search.',
  'voz.spremi': 'Save', 'voz.odustani': 'Cancel', 'voz.uredi': 'Edit',
  'voz.deaktiviraj': 'Deactivate (left)', 'voz.aktiviraj': 'Reactivate', 'voz.obrisi': 'Delete',
  'voz.trebaIme': 'Enter the driver name.', 'voz.potvrdiBrisanje': 'Delete driver {ime}?',
  'zad.opis': 'Handover form — documents and equipment when assigning a truck and trailer to a driver.',
  'zad.novo': 'New handover', 'zad.naslov': 'Handover',
  'zad.trazi': 'Search by plate or driver…',
  'zad.nema': 'No handovers yet. Create the first one.',
  'zad.nemaRezultata': 'No results for that search.',
  'zad.datum': 'Date', 'zad.kamion': 'Truck', 'zad.prikolica': 'Trailer',
  'zad.kamionReg': 'Truck — registration', 'zad.prikolicaReg': 'Trailer — registration', 'zad.regPh': 'e.g. ZG 1234-AB',
  'zad.vozac': 'Driver', 'zad.vozacPh': 'driver full name', 'zad.odaberiVozaca': '— select driver —',
  'zad.noviVozac': 'Other driver (type)…', 'zad.izPopisa': 'pick from list',
  'zad.faliPolja': 'Required fields: {polja}',
  'zad.preuzeo': 'Received by', 'zad.predao': 'Handed over by', 'zad.odradio': 'Checked by',
  'zad.status': 'Status', 'zad.uTijeku': 'In progress', 'zad.zavrseno': 'Completed',
  'zad.oprema': 'Equipment / document', 'zad.kom': 'Qty', 'zad.napomena': 'Note',
  'zad.napomenaKratko': 'Note',
  'zad.sviPredani': 'All handed over (+)', 'zad.ocisti': 'Clear',
  'zad.predana': 'Handed over', 'zad.manjka': 'Missing',
  'zad.predano': 'Handed over: {n} / {uk}',
  'zad.spremi': 'Save', 'zad.spremljeno': 'Saved ✓', 'zad.zavrsi': 'Complete',
  'zad.vratiTijek': 'Reopen', 'zad.ispisi': 'Print', 'zad.obrisi': 'Delete',
  'zad.potvrdiBrisanje': 'Delete this handover?',
  'zad.greskaUcitavanje': 'Error while loading.',
  'prikapcanje.opis': 'Who drives which trailer + log of coupling and uncoupling (record/proof).',
  'prikapcanje.trenutno': 'Now — who drives which trailer',
  'prikapcanje.nemaTrenutno': 'No trailers currently coupled in the record.',
  'prikapcanje.dnevnik': 'Event log',
  'prikapcanje.trazi': 'Search by truck, trailer, plate or driver…',
  'prikapcanje.nemaRezultata': 'No results for this search.',
  'prikapcanje.novaPromjena': 'New change (couple / uncouple)',
  'prikapcanje.odaberiPrikolicu': '— select trailer —',
  'prikapcanje.odaberiKamion': '— select truck —',
  'prikapcanje.trebaPrikolica': 'Select a trailer.',
  'prikapcanje.trebaKamion': 'To couple, select a truck (not needed for uncouple).',
  'prikapcanje.napomenaUnos': 'Couple = trailer goes onto the selected truck. Uncouple = trailer is detached (becomes free).',
  'prikapcanje.potvrdiZamjenu': 'Truck {kamion} already pulls trailer {stara}. Uncouple it and couple {nova}?',
  'tab.servisi': 'Service',
  'servisi.opis': 'Next service due per truck (last service + 12 months). Km condition coming soon.',
  'servisi.trazi': 'Search by yard no., plate or type…',
  'servisi.kamiona': 'trucks', 'servisi.dospjelo': 'Due', 'servisi.uskoro': 'Soon', 'servisi.ok': 'OK', 'servisi.nepoznato': 'Unknown',
  'servisi.zadnji': 'Last service', 'servisi.iduci': 'Next', 'servisi.prag': 'Threshold', 'servisi.mj': 'mo',
  'servisi.proslo': 'overdue', 'servisi.jos': 'in', 'servisi.dana': 'days', 'servisi.obavljen': 'Service done',
  'servisi.km': 'Km', 'servisi.prekoraceno': 'over by',
  'spremne.opis': 'Ready (repaired) trailers and where they are parked — so we know what we have.',
  'spremne.zaUpisati': 'To record', 'spremne.zaUpisatiOpis': 'These trailers finished their work order, but it is not recorded whether they are ready and where they are parked. Record it so they are not forgotten.',
  'spremne.spremne': 'Ready trailers', 'spremne.nema': 'No ready trailers right now.',
  'spremne.spremnoBtn': 'Ready', 'spremne.uzeta': 'Taken', 'spremne.od': 'since',
  'spremne.gdjeParkirana': 'Where is it parked?', 'spremne.lokPlaceholder': 'e.g. Parking Sesvete, Shop…',
  'spremne.lokObavezna': 'Choose a parking.',
  'spremne.parkinzi': 'Parkings', 'spremne.nemaParkinga': 'No parkings yet — add at least one.',
  'spremne.noviParking': 'Parking name', 'spremne.dodajParking': 'Add',
  'spremne.odaberiParking': '— choose parking —', 'spremne.trebaParking': 'A manager must add a parking first (⬆ Parkings).',
  'spremne.uzetaNaslov': 'Who took the trailer? (optional)', 'spremne.kamionGb': 'Truck yard no. (opt.)', 'spremne.vozacOpc': 'Driver (opt.)',
  'spremne.evidencija': 'Coupling log', 'spremne.nemaEvidencije': 'No records.',
  'spremne.prikaceno': 'Coupled', 'spremne.otkaceno': 'Uncoupled', 'spremne.ispisi': 'Print',
  'spremne.kada': 'When', 'spremne.dogadaj': 'Event', 'spremne.prikolica': 'Trailer', 'spremne.kamion': 'Truck',
  'spremne.vozac': 'Driver', 'spremne.lokacijaKol': 'Location',
  'spremne.kamioni': 'Finished trucks', 'spremne.nemaKamiona': 'No finished trucks at the shop right now.',
  'spremne.kamioniOpis': 'Trucks stay here until they leave the shop area (~{km} km). They drop off as soon as they leave (by GPS).',
  'spremne.nemaGps': 'no GPS', 'spremne.prikaziNaKarti': 'Show on map (Google Maps)', 'spremne.karta': 'map',
  'kat.kamion': 'Trucks', 'kat.prikolica': 'Trailers', 'kat.kombi': 'Vans', 'kat.auto': 'Cars', 'kat.ostalo': 'Other',
  'nezaduzena.opis': 'Vehicles manually set to status “Unassigned” in the vehicle master list.',
  'nezaduzena.nema': 'No unassigned trailers.', 'nezaduzena.slobodnih': 'free trailers',
  'nezaduzena.nijeURadionici': 'not in the shop', 'nezaduzena.nedostupno': 'Flota OS is currently unavailable — try later.',
  'parking.ispisi': 'Print log', 'parking.zaRijesiti': 'To resolve', 'parking.nemaZa': 'No trailers awaiting a location.',
  'parking.evidencija': 'Log', 'parking.poslano': 'Sent', 'parking.otvoreno': 'Opened', 'parking.rijeseno': 'Resolved',
  'parking.gdjeParkirano': 'Where is the trailer parked?', 'parking.phLok': 'e.g. behind hall, row B', 'parking.spremiLok': 'Save location',
  'parking.upisiLok': 'Enter a location.', 'parking.lokacija': 'Location', 'parking.ispisNaslov': 'Trailer parking log',
  'izasli.opis': 'Trucks that left the workshop while an order is still in progress.',
  'izasli.nema': 'No vehicles outside the workshop with an open order right now.',
  'izasli.zavrsi': 'Finish order',
  'nadzor.izbornik': 'Ongoing work', 'nadzor.tekuci': 'Ongoing work', 'nadzor.zavrsi': 'Finish', 'nadzor.odjavi': 'Sign off', 'nadzor.uTijeku': 'in progress', 'nadzor.vozilaURadu': 'Trucks in service',
  'nadzor.nemaTekucih': 'No active timers right now.', 'nadzor.nemaAktivnih': 'No active work orders.',
  'nadzor.slobodni': 'Available workers', 'nadzor.sviZauzeti': 'All workers are signed in.',
  'common.zatvori': 'Close', 'nav.izbornik': 'Menu',
  'radnik.dodaj': 'Add worker', 'radnik.imePlaceholder': 'Worker full name',
  'radnik.pocLozinka': 'Initial password (worker changes it later)', 'radnik.spremiDodaj': 'Add',
  'radnik.imeObavezno': 'Enter the worker name.', 'radnik.vecPostoji': 'A worker with that name already exists.',
  'radnik.dodan': 'Worker added', 'radnik.korisnicko': 'username', 'radnik.lozinka': 'password',
  'radnik.josJedan': 'Add another',
  'ods.dostupan': 'Available', 'ods.godisnji': 'Annual leave', 'ods.bolovanje': 'Sick leave', 'ods.od': 'From', 'ods.do': 'To',
  ...
  'nalog.ispisi': 'Print work order', 'nalog.povijestVozila': 'Vehicle history',
  'nalog.uredi': 'Edit', 'nalog.naslovPh': 'Order title', 'nalog.opisPh': 'Description / note',
  ...
  'profil.testPush': '📨 Send a test notification', 'profil.testPoslano': 'Test notification sent — check your device. 📲',
  'profil.pushServer': 'Push is not enabled on the server yet (VAPID keys missing).',
  'profil.pushNepodrzano': 'This browser/device does not support push notifications.',
  'profil.pushGreska': 'Error enabling notifications — please try again.',
  ...
  'steta.uredi': 'Edit', 'steta.urediNaslov': 'Edit damage', 'steta.spremiIzmjene': 'Save changes',
  'steta.dodajStavku': '+ add item', 'steta.nazivStavke': 'Item', 'steta.cijenaStavke': 'Price (€)',
  'steta.postaviUkupno': '= sum of items',
  'sif.title': 'Vehicle history', 'sif.korisnici': 'Workers', 'sif.vozila': 'Vehicles', 'sif.dijelovi': 'Parts',
  ...
  'sif.noviKorisnik': 'Add worker', 'sif.ime': 'Full name', 'sif.korime': 'Username',
  'sif.korimeHint': 'Auto-generated from the name — you can change it. Default password radnik123 (worker changes it later).',
  'sif.stoJe': 'What are they?',
  'sif.autoHint': 'Username and password are assigned automatically — you get them after saving.',
  'sif.predaj': 'Hand these details to the worker; they change the password later.',
  'vrsta.serviser': 'Mechanic (signs in to orders)', 'vrsta.neprijavljuje': 'Does not sign in (e.g. warehouse)',
  'vrsta.poslovodja': 'Foreman', 'vrsta.voditelj': 'Manager', 'vrsta.vozac': 'Driver',
  ...
  'sif.vrsta': 'Type', 'sif.serviser': 'Mechanic (signs in)', 'sif.nePrijavljuje': 'Does not sign in (e.g. warehouse)',
  'sif.postaviNePrijavljuje': 'Set: does not sign in', 'sif.postaviServiser': 'Set: mechanic',
