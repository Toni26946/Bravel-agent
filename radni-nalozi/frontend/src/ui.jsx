...
export const KATEGORIJE = [
  ...
  'BLATOBRANI 1', 'KOČNICE 2. OSOVINA', 'IZRADA HIDRAULIČNIH CRIJEVA', 'SERVIS', 'PODMAZIVANJE', 'NADOGRADNJA',
  ...
  'REPARATURA SEDLA, VUČNE KUKE, RUDE', 'MATERIJAL ZA TEREN', 'KOČNICE 3. OSOVINA', 'BLATOBRANI 3', 'REPARATURA ČELJUSTI', 'BOJANJE 2',
  ...
  'Elektrika 2', 'KOČNICE 1. OSOVINA', 'BOČNA ZAŠTITA I BRANIK 2', 'DIJELOVI DIZALICE 2', 'DIJELOVI OVJESA 2', 'ŠASIJA 2',
