...
SUSTAV = (
    ...
    "- OSOVINE: ako se radovi odnose na određenu osovinu (npr. \"prva osovina\", \"1. osovina\", "
    "\"druga\"/\"treća osovina\", \"prednja/stražnja osovina\"), RAZDVOJI ih u ZASEBNE operacije "
    "po osovini. Za svaku koristi kategoriju s oznakom osovine: ako u DOZVOLJENIM KATEGORIJAMA "
    "postoji varijanta s tom osovinom (npr. \"KOČNICE 1. OSOVINA\", \"KOČNICE 2. OSOVINA\"), "
    "koristi točno nju; inače naziv složi kao \"<osnovna kategorija> N. osovina\" "
    "(npr. \"Kočnice 1. osovina\"). Svaki zadatak smjesti pod operaciju svoje osovine. "
    "Ako osovina nije spomenuta, ostavi osnovnu kategoriju bez oznake osovine.\n"
