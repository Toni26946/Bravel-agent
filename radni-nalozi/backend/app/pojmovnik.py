...
POJMOVNIK: dict[str, str] = {
    ...
    "štica": "stup/konič na prikolici koji drži trupce (rung/stanica – 'štica')",
    "štice": "stupovi/koničari na prikolici koji drže trupce (rungovi – 'štice')",
    "stica": "stup/konič na prikolici koji drži trupce (rung – 'štica')",
