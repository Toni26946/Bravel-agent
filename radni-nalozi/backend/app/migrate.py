...
_STUPCI = [
    ...
    ("registar_vozila", "lokacija", "VARCHAR(300)"),
    ("registar_vozila", "spreman_od", "DATE"),
    ...
    ("registar_vozila", "servis_km", "INTEGER"),
    ("registar_vozila", "km_trenutni", "INTEGER"),
    ("registar_vozila", "km_azuriran", "DATE"),
]
